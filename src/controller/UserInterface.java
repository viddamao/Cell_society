...
public class UserInterface {
	 ...
	 * intFromResource("edge_radio_button3_y"), edgeGroup, new
	 * EventHandler<ActionEvent>() {
	 * 
	 * @Override public void handle(ActionEvent event) { if (myGrid != null)
	 * { myGrid.setEdgeRules(2); } } }));
	 */
	myRootPane.getChildren().add(
		createRadioButton(
			ourMessages.getString("edge_radio_button2_title"),
			...
			new EventHandler<ActionEvent>() {
				...
				if (myGrid != null) {
				    myGrid.changeRulesTo(new ToroidalEdgeRules(
					    myGrid.getGridWidth(), myGrid
						    .getGridHeight(), myGrid));
				}
			    }
			}));
	myRootPane.getChildren().add(
		createRadioButton(
			ourMessages.getString("edge_radio_button1_title"),
	...
	myRootPane.getChildren().add(
		createRadioButton(
			ourMessages.getString("shape_radio_button3_title"),
	...
	myRootPane.getChildren().add(
		createRadioButton(
			ourMessages.getString("shape_radio_button2_title"),
	...
	myRootPane.getChildren().add(
		createRadioButton(
			ourMessages.getString("shape_radio_button1_title"),
